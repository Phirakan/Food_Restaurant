...
<body>
    ...
    <div class="container complete-order-box">
        <div class="confirmation-box">
            ...
            <p class="confirmation-text">หมายเลข Order: 12345</p>
            <p class="confirmation-text">ร้านอาหารของเรากำลังทำอาหาร</p>
            <p class="confirmation-text">ขอให้ทานอาหารอร่อย!</p>
            <a href="../order-menu.php?restaurant=<?php echo $_SESSION['restaurant_id_customer'] ?>" class="confirmation-link"><i class="fas fa-home"></i> กลับสู่หน้าหลัก</a>
        </div>
    </div>
