        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav menunavbar">
                    ...
                    <li class="nav-item">
                        <a  href="../page/result/result.php" class="btn btn-store-atnav" style="gap:8px;"><i class="bi bi-receipt"></i>ยอดคำสั่งซื้อ</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <button type="button" class="btn btn-qrcode-gen" id="generate-qrcode-btn" onclick="generateQRCode()">สร้าง QRCODE</button>
                    </div>
                </div>
            </div>
        </div>
